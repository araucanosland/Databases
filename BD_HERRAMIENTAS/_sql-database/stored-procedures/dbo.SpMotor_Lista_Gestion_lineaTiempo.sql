IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[dbo].[SpMotor_Lista_Gestion_lineaTiempo]') AND type = 'P')
DROP PROCEDURE [dbo].[SpMotor_Lista_Gestion_lineaTiempo]
GO
--exec [dbo].[SpMotor_Lista_Gestion_lineaTiempo]'9065257-5'
--exec [dbo].[SpMotor_Lista_Gestion_lineaTiempo]'15473876-2'
--SELECT * FROM TABMOTOR_NO_MOLESTAR where RutAfiliado = '15473876-2'
CREATE PROCEDURE [dbo].[SpMotor_Lista_Gestion_lineaTiempo](
