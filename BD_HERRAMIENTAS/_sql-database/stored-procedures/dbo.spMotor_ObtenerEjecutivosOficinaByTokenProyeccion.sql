IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[dbo].[spMotor_ObtenerEjecutivosOficinaByTokenProyeccion]') AND type = 'P')
DROP PROCEDURE [dbo].[spMotor_ObtenerEjecutivosOficinaByTokenProyeccion]
GO
CREATE PROCEDURE [dbo].[spMotor_ObtenerEjecutivosOficinaByTokenProyeccion]
(
	@Token varchar(50),
	@Periodo INT
)
