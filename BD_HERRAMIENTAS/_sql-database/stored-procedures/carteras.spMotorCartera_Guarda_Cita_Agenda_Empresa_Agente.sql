IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[carteras].[spMotorCartera_Guarda_Cita_Agenda_Empresa_Agente]') AND type = 'P')
DROP PROCEDURE [carteras].[spMotorCartera_Guarda_Cita_Agenda_Empresa_Agente]
GO


CREATE PROCEDURE [carteras].[spMotorCartera_Guarda_Cita_Agenda_Empresa_Agente]
@TOKEN VARCHAR(300)
,@RUT_EMPRESA VARCHAR(15)
,@RUT_EJECUTIVO VARCHAR(15)
