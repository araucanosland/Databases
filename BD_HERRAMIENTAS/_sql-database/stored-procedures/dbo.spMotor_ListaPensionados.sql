IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[dbo].[spMotor_ListaPensionados]') AND type = 'P')
DROP PROCEDURE [dbo].[spMotor_ListaPensionados]
GO
CREATE PROCEDURE [dbo].[spMotor_ListaPensionados]--'90fc16b8-1b13-4808-bc51-2d32c2f5ad83','','','','',101
(
	@TOKEN VARCHAR(500),
	@NOMBRE VARCHAR(500) = '',
	@COMUNA VARCHAR(200) = '',
