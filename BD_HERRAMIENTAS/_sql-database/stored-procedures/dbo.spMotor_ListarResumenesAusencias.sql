IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[dbo].[spMotor_ListarResumenesAusencias]') AND type = 'P')
DROP PROCEDURE [dbo].[spMotor_ListarResumenesAusencias]
GO
CREATE PROCEDURE [dbo].[spMotor_ListarResumenesAusencias]
(
	@TOKEN VARCHAR(50),
	@PERIODO INT
)
...
BEGIN
	...
	WHERE Cod_Sucursal = @COD_OFICINA
	AND Periodo = @PERIODO
	...
	inner join dbo.TabMotor_Dotacion b ON a.ejec_rut = b.Rut
	...
	AND B.Cod_Sucursal = @COD_OFICINA
