IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[dbo].[TabMotor_Asignacion_Hist_v2]') AND type = 'U')
CREATE TABLE [dbo].[TabMotor_Asignacion_Hist_v2]
(
