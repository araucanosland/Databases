IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[scafi].[TabMotor_Contactibilidad_RSP_CARLOS]') AND type = 'U')
CREATE TABLE [scafi].[TabMotor_Contactibilidad_RSP_CARLOS]
(
