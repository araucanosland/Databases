IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[licencias].[SC_TabLic_IngresoLicencia_38686222]') AND type = 'U')
CREATE TABLE [licencias].[SC_TabLic_IngresoLicencia_38686222]
(
