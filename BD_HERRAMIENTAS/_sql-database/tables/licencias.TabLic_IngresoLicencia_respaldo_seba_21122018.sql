IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[licencias].[TabLic_IngresoLicencia_respaldo_seba_21122018]') AND type = 'U')
CREATE TABLE [licencias].[TabLic_IngresoLicencia_respaldo_seba_21122018]
(
