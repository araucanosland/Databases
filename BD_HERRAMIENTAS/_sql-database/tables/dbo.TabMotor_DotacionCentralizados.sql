IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('[dbo].[TabMotor_DotacionCentralizados]') AND type = 'U')
CREATE TABLE [dbo].[TabMotor_DotacionCentralizados]
(
    [Oficina] float NULL,
